...
<fieldset>
	...
	<a href="javascript:void(0);" onclick="window.location.href='<?php echo base_url(); ?>index.php/cabang/pengiriman'" class="btn btn-primary pull-right"><i class="icon-ok-circle icon-white"></i>&nbsp;Selesai</a>
	<!-- Modal -->
	<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/pengiriman/add_barang_cabang?id_cust=<?=$_GET['id_cust']?>">
