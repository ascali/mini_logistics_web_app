    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="<?= base_url(); ?>assets/vendor/adminlte/#">
          ...
          <?= $this->session->userdata('nama_agen'); ?>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header"></span>
          <!-- <div class="dropdown-divider"></div> -->
          <a href="<?php echo base_url(); ?>index.php/agen/logout" class="dropdown-item">
  ...
  <aside class="main-sidebar elevation-4 sidebar-dark-lightblue">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?= base_url(); ?>assets/vendor/adminlte/#" class="d-block">Hi, <?= $this->session->userdata('nama_agen'); ?></a>
        </div>
      </div>
