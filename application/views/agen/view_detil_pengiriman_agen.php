...
<fieldset>
	...
	<a href="javascript:;" onclick="window.open('<?php echo base_url(); ?>index.php/pengiriman/cetak_detil_agen/<?php echo $id; ?>', 800, 600);" 
		class="btn btn-primary">
		<i class="icon-print icon-white"></i>&nbsp;Cetak</a>
	<a href="javascript:void(0);" onclick="window.location.href='<?php echo base_url(); ?>index.php/agen/tracking'" class="btn btn-primary pull-right"><i class="icon-ok-circle icon-white"></i>&nbsp;Selesai</a>
	<!-- Modal -->
	<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/pengiriman/add_barang_agen?id_cust=<?=$_GET['id_cust'];?>">
