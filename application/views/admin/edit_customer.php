<?php
echo heading('Detil Data Customer', 3);
if (count($customer) > 0) {
	...
	<div>
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="form-control" class="span4" type="text" id="inputEmailCust" name="txtEmailCust" placeholder="Email"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="form-control" type="password" class="span4" id="inputPasswordCust" name="txtPasswordCust" 
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="form-control" type="text" class="span4" id="inputNamaCust" name="txtNamaCust" placeholder="Nama Lengkap" 
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="form-control" class="span4" type="text" name="rbJenisKelCust" value="<?php echo $jenkel; ?>" 
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="form-control" type="text" class="span4" name="txtTglLahirCust" class="datepicker" 
						value="<?php echo $tgl; ?>" 
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="form-control" class="span4" class="span4" name="txtAlamatCust" id="inputAlamat" rows="3" 
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="form-control" type="text" class="span4" name="txtKotaCust" value="<?php echo $kota; ?>" 
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="form-control" type="text" class="span4" name="txtNoTelpCust" id="txtNoTelpCust" 
						value="<?php echo $telp; ?>" 
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="form-control" type="text" class="span4" name="txtPerusahaanCust" id="txtPerusahaanCust" 
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="form-control" class="span4" type="text" name="cbBidangKerja" id="cbBidangKerja" 
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea class="form-control" class="span4" id="txtAlamatPerCust" name="txtAlamatPerCust" rows="3" 
